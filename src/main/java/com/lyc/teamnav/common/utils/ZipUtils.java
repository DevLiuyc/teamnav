...
import com.lyc.teamnav.common.exception.UnzipException;
...
public class ZipUtils {
    ...
    public static void unzip(String id, String zipPath) {
        try (ZipFile zipFile = new ZipFile(Constants.ROOT_DIR + zipPath)) {
            ...
            String savePath = StringExtUtils.format("{}/ext-resources/modules/{}/", Constants.ROOT_DIR, id);
